...
namespace PowerEntity.UDT
{
    ...
    [OracleCustomTypeMapping("ADMIN.TYP_PES_BANK_ACCOUNTS")]
    public class TypPesBankAccountsFactoryUdt : IOracleCustomTypeFactory, IOracleArrayTypeFactory
    {
