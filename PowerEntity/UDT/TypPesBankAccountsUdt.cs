...
namespace PowerEntity.UDT
{
    ...
    public class TypPesBankAccountsUdt : IOracleCustomType, INullable
    {
        // The OracleArrayMapping attribute is required to map .NET class member to Oracle collection type.
        [OracleArrayMapping()]
        public TypPesBankAccountUdt[] objBankAccounts;
        ...
        {
            OracleUdt.SetValue(con, pUdt, 0, objBankAccounts);
        }
        ...
        {
            objBankAccounts = (TypPesBankAccountUdt[])OracleUdt.GetValue(con, pUdt, 0);
        }
        ...
        public static TypPesBankAccountsUdt Null
        {
            get
            {
                TypPesBankAccountsUdt obj = new TypPesBankAccountsUdt();
