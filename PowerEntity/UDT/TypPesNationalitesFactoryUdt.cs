...
namespace PowerEntity.UDT
{
    ...
    [OracleCustomTypeMapping("ADMIN.TYP_PES_NATIONALITIES")]
    public class TypPesNationalitesFactoryUdt : IOracleCustomTypeFactory, IOracleArrayTypeFactory
    {
