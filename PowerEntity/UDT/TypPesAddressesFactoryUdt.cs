...
namespace PowerEntity.UDT
{
    ...
    [OracleCustomTypeMapping("ADMIN.TYP_PES_ADDRESSES")]
    public class TypPesAddressesFactoryUdt : IOracleCustomTypeFactory, IOracleArrayTypeFactory
    {
